...
namespace Trapeze
{
    public class Trap_Figure : Figure
    {
        ...
        public Trap_Figure(int ex, int ey)
        {
            this.Initialization();
        ...
        public Trap_Figure(Point ep1, Point ep2)
        {
            this.Initialization();
        ...
        {
            this.coord[0] = new Point(this.Left_Top.X + this.LX / 3, this.Left_Top.Y);
            this.coord[1] = new Point(this.Right_Down.X - this.LX / 3, this.Left_Top.Y);
        ...
        override public void RestFigure(IFigure f)
        {
            this.Name = f.Name;
            this.isCreat = f.isCreat;
            this.A = f.A;
